...
<html>
    ...
    <body>
        ...
        <div id="show-repository" class="content scaffold-show" role="main">
            ...
            <g:form resource="${repository}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${repository}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
