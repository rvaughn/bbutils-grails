...
<html>
    ...
    <body>
        ...
        <div id="show-memberGroup" class="content scaffold-show" role="main">
            ...
            <g:form resource="${memberGroup}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${memberGroup}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
